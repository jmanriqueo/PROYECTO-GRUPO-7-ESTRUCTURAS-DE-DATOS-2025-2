...
public class MatterGraph {
    ...
    private void cargarMaterias() {
        ...
        // ===== CICLO BÁSICO =====
        matters.put(1, new Matter(1, "Introducción a la carrera"));
        matters.put(2, new Matter(2, "Matemáticas Básicas",
                Arrays.asList(Arrays.asList(1))));
        matters.put(3, new Matter(3, "Programación I",
                Arrays.asList(Arrays.asList(1))));

        // ===== CICLO INTERMEDIO =====
        matters.put(4, new Matter(4, "Estructuras de Datos",
                Arrays.asList(Arrays.asList(3))));
        matters.put(5, new Matter(5, "Matemáticas Discretas",
                Arrays.asList(Arrays.asList(2))));
        matters.put(6, new Matter(6, "Bases de Datos",
                Arrays.asList(Arrays.asList(3))));

        // ===== CICLO AVANZADO =====
        matters.put(7, new Matter(7, "Algoritmos",
                Arrays.asList(Arrays.asList(4), Arrays.asList(5))));
        matters.put(8, new Matter(8, "Sistemas Operativos",
                Arrays.asList(Arrays.asList(4))));
        matters.put(9, new Matter(9, "Ingeniería de Software",
                Arrays.asList(Arrays.asList(6), Arrays.asList(4))));

        // ===== CIERRE =====
        matters.put(10, new Matter(10, "Trabajo de Grado",
